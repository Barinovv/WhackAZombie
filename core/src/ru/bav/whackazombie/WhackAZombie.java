...
import ru.bav.whackazombie.managers.GameManager;
...
public class WhackAZombie extends ApplicationAdapter {
    ...
    @Override
    public void create() {
        // получение размеров экрана устройтсва
        float height = Gdx.graphics.getHeight();
        float width = Gdx.graphics.getWidth();
        // устанавление размеров экрана устройства в качестве размеров области просмотра игры
    ...
    public void render() {
        ...
        // передача вида с "камеры" в spritebatch
